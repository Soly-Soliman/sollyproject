...
class Bicycling extends StatefulWidget {
  const Bicycling({Key? key,}) : super(key: key);

  @override
  State<Bicycling> createState() => _BicyclingState();
}
...
class _BicyclingState extends State<Bicycling> {
    ...
    return Scaffold(
      ...
      appBar: PreferredSize(
        ...
        child: AppBar(
          ...
          title: const Text('Bicycling',style: TextStyle(color: black ,fontFamily: 'Sofiar'),),
          centerTitle: true,
        ),
      ),
      body: Scaffold(
  ...
  Future<List<BasketballModel>> ReadJsonData() async {
    final jsondata = await rootBundle.rootBundle.loadString('jsonfile/Bicycling.json');
